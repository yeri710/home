...
export default async function handler(req) {
  ...
  const pageNo = searchParams.get("pageㅌNo") || "1";
  ...
  officetel:"https://api.odcloud.kr/api/ApplyhomeInfoDetailSvc/v1/getULttotPblancDetail",
  urban:    "https://api.odcloud.kr/api/ApplyhomeInfoDetailSvc/v1/getULttotPblancDetail",
  lodging:  "https://api.odcloud.kr/api/ApplyhomeInfoDetailSvc/v1/getULttotPblancDetail",
};
